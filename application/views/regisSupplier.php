      ...
      <div class="container pt-11 pt-md-13 pb-11 pb-md-19 pb-lg-22 text-center">
        <div class="row">
          <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto" data-cues="slideInDown" data-group="page-title">
            <h5 class="display-1 fs-45 mb-4 px-md-15 px-lg-0">Create your company profile <span class="underline-3 style-3 primary">easily</span></h5>
            <p class="lead fs-18 lh-sm mb-7 mx-md-13 mx-lg-10">Get your own easy to edit and manage your own product, company profile for your business</p>
            <div>
            </div>
          </div>
          <!-- /column -->
