        ...
        <div class="content">
          ...
          <div class="block block-rounded overflow-hidden">
            <ul class="nav nav-tabs nav-tabs-block" role="tablist">
              <li class="nav-item">
                <button type="button" class="nav-link active" id="search-projects-tab" data-bs-toggle="tab" data-bs-target="#search-projects" role="tab" aria-controls="search-projects" aria-selected="true">Data Inquire</button>
              </li>
            </ul>
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                            ...
                            <tbody>
                            <?php $no=1; foreach ($inquire as $data) :?>
                                <tr>
                                    <td class="text-center" style="width: 80px;"><?= $no++?></td>
                                    <td class="text-center" ><?= $data->nama?></td>
                                    <td class="text-center" ><a href=""><?= $data->email?></a></td>
                                    <td class="text-center" ><?= $data->negara?></td>
                                    <td class="text-center" ><?= $data->namaProduk?></td>
                                    <td class="text-center" ><?= $data->namaPerusahaan?></td>
                                    <td  class="text-center">
                                      <a class="btn btn-sm btn-alt-secondary" href="<?= base_url('admin/detailInquire/'.$data->idinquire)?>" data-bs-toggle="tooltip" title="View">
