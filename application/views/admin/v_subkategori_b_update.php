                            ...
                            <form action="<?= base_url('admin/subkategoriB/tambahsubkategoriB')?>" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <?php foreach ($subkategoria as $data) : ?>
                                        <option value="<?= $data->idsubkategori_a?>" <?= $data->idkategori == $subkategorib[0]->idsubkategori_a ? 'selected' : '' ?>><?= $data->namaSubKategori?></option>
                                    <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="mb-4">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, item) {
                        options += '<option value="' + item.idsubkategoria + '">' + item.namasubkategori_a + '</option>';
                    });
