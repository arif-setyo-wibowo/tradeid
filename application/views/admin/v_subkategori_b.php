                    ...
                    <div class="col-lg-5 space-y-5">
                        ...
                        <form action="<?= base_url('admin/subkategoriB/tambahsubkategoriB')?>" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="js-select2 form-select" id="idsubkategoria" name="namaKategori" style="width: 100%;" data-placeholder="Pilih Kategori" required>
                                <option disable value=""></option>
                                    <option value=""></option>
                                </select>
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="namasubkategori_b" name="namaSubKategori" placeholder="Sub Kategori A">
                            </div>
                            <div class="mb-4">
